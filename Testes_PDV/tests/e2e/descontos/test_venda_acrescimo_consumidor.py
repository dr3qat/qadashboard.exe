"""
Test Venda Acrescimo Consumidor - Venda consumidor com acrescimo de R$ 10,00.
"""
import pytest
import allure
...
class TestVendaAcrescimoConsumidor:

    @allure.title("Venda Acrescimo Consumidor - R$ 10,00 Dinheiro")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.tag("venda", "consumidor", "acrescimo", "dinheiro")
    def test_venda_acrescimo_consumidor(self, driver_logado):
        """Venda consumidor com acrescimo R$ 10,00 — valida restante zerado antes de finalizar."""
        ...
        with allure.step("3. Venda consumidor + acrescimo R$ 10,00 + DINHEIRO"):
            pagina_venda.executar_venda_consumidor_com_acrescimo(
