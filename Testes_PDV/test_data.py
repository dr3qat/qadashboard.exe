...
# Detecta se esta rodando em CI (GitHub Actions)
...
class TestData:
    ...
    _CUSTOMER_ID_LOCAL = "1"   # Cliente para execucao local
    _default_customer = _CUSTOMER_ID_CI if IS_CI else _CUSTOMER_ID_LOCAL
